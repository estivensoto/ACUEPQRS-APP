  ...
  return (
    <div className="producto-container">
      <aside className="menu-lateral">
        ...
        <ul>
          <li>
            <img src="/imagenes/peticion.png" alt="Petición" />
            <Link to="/peticion">PETICION</Link>
          </li>
          <li>
            <img src="/imagenes/queja.png" alt="Queja" />
            <Link to="/queja">QUEJA</Link>
          </li>
          <li>
            <img src="/imagenes/reclamo.png" alt="Reclamo" />
            <Link to="/reclamo">RECLAMO</Link>
          </li>
          <li>
            <img src="/imagenes/sugerencias.png" alt="Sugerencia" />
      ...
      <main className="contenido-principal">
        ...
        <div className="logo-acue">
          <img src="/imagenes/LOGOACUEPQRS.jpg" alt="Logo ACUEpqrs" />
        </div>
      </main>
    </div>
  );
